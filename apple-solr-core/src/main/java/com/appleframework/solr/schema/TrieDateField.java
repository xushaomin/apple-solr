...
import com.appleframework.solr.util.DateFormatUtil;
 ...
 * </ul>
 * <p>
 * Note that TrieDateField is lenient with regards to parsing fractional seconds
 ...
 * </p>
 * <p>
 * <b>NOTE:</b> Although it is possible to configure a
 * <code>TrieDateField</code> instance with a default value of
 * "<code>NOW</code>" to compute a timestamp of when the document was indexed,
 * this is not advisable when using SolrCloud since each replica of the document
 * may compute a slightly different value.
...
public class TrieDateField extends TrieField implements DateValueFieldType {
	...
	/**
	 * @deprecated Use
	 *             {@link DateFormatUtil#parseDateLenient(String,SolrQueryRequest)}
	 */
	@Deprecated
	...
	/**
	 * @deprecated Use
	 *             {@link DateFormatUtil#parseMathLenient(Date, String, SolrQueryRequest)}
	 */
	@Deprecated
