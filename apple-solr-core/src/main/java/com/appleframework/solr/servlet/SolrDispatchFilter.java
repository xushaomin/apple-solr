...
public class SolrDispatchFilter extends BaseSolrFilter {
  ...
  public void init(FilterConfig config) throws ServletException
  {
    ...
    try {
      ...
      CoreContainerManager.cores = createCoreContainer(solrHome == null ? SolrResourceLoader.locateSolrHome() : Paths.get(solrHome),
                                       extraProperties);
      this.httpClient = CoreContainerManager.cores.getUpdateShardHandler().getHttpClient();
  ...
  protected CoreContainer createCoreContainer(Path solrHome, Properties extraProperties) {
    ...
    CoreContainerManager.cores = new CoreContainer(nodeConfig, extraProperties, true);
    CoreContainerManager.cores.load();
    return CoreContainerManager.cores;
  }
  ...
  public CoreContainer getCores() {
    return CoreContainerManager.getCores();
  }
  
  @Override
  public void destroy() {
	  CoreContainerManager.destroy();
  }
...
public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain, boolean retry) throws IOException, ServletException {
    ...
    try {
      ...
      if (CoreContainerManager.cores == null || CoreContainerManager.cores.isShutDown()) {
      ...
      if (CoreContainerManager.cores.getAuthenticationPlugin() != null) {
  ...
  protected HttpSolrCall getHttpSolrCall(HttpServletRequest request, HttpServletResponse response, boolean retry) {
    return new HttpSolrCall(this, CoreContainerManager.cores, request, response, retry);
  }
  ...
  private boolean authenticateRequest(ServletRequest request, ServletResponse response, final AtomicReference<ServletRequest> wrappedRequest) throws IOException {
    ...
    AuthenticationPlugin authenticationPlugin = CoreContainerManager.cores.getAuthenticationPlugin();
    if (authenticationPlugin == null) {
      ...
      if (header != null && CoreContainerManager.cores.getPkiAuthenticationPlugin() != null)
        authenticationPlugin = CoreContainerManager.cores.getPkiAuthenticationPlugin();
      try {
